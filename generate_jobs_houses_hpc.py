...
template = 'grass79 --tmp-mapset {location} --exec python  {viewshed_script} output={results_dir}{out} input=dem input_dsm=dsm dem_buffer=10 sample_continuous=tri sample_categorical=lc1992,lc2001,lc2006,lc2011,lc2016,neighbors1,neighbors2,neighbors3,neighbors4,neighbors5,neighbors6,fires1,fires2,fires3,fires4,fires5,fires6 max_distance=10000 observer_elevation=3 coordinates={x},{y} view_id={pid} memory=40000 --o \n'
